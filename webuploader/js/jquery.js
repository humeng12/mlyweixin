...
(function(e, t) {
		...
		function(e, t) { var n, r, i, o, a, s, u, l, c, p, f, d, h, g, m, y, v, x = "sizzle" + -new Date,
			...
			function vt(e) { var t, n, r, o = e.length,
					...
					if(n = i.relative[e[u].type]) f = [ht(gt(f), n)];
								...
								if(i.relative[e[r].type]) break; return yt(u > 1 && gt(f), u > 1 && dt(e.slice(0, u - 1)).replace(W, "$1"), n, r > u && vt(e.slice(u, r)), o > r && vt(e = e.slice(r)), o > r && dt(e)) } f.push(n) }
				return gt(f) }
			...
			function bt(e, t) { var n = 0,
					...
					s = function(s, u, c, f, d) { var h, g, m, y = [],
							...
							k = N += null == T ? 1 : Math.random() || .1; for(w && (l = u !== p && u, r = n); null != (h = C[b]); b++) { if(a && h) { g = 0; while(m = e[g++])
								...
								w && (N = k, r = ++n) } o && ((h = !m && h) && v--, s && x.push(h)) } if(v += b, o && b !== v) { g = 0; while(m = t[g++]) m(x, y, u, c); if(s) { if(v > 0)
	...
	function Fn(e, t) { var n, r, i, o, a = {},
			...
			if("*" !== r) { if("*" !== l && l !== r) { if(i = a[l + " " + r] || a["* " + r], !i)
					...
					if(i !== !0)
						if(i && e["throws"]) t = i(t);
						else try { t = i(t) } catch(c) { return { state: "parsererror", error: i ? c : "No conversion from " + l + " to " + r } } } l = r }
